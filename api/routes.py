...
engine=SovereignMasterEngine(models=ModelRegistry())
...
def status(): return {**health(),"providers":engine.orchestrator.models.health(),"capabilities":engine.orchestrator.models.metadata()}
