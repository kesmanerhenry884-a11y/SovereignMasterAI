...
app = FastAPI(
    ...
    version="2.0.0",
    description="Modular AI orchestration engine for reasoning, knowledge, memory, research, media, location and multilingual workflows.",
)
...
def status_endpoint():
    return {
        ...
        **engine.status(),
        ...
        "reminders": {"enabled": True, "client_delivery_required": True},
    }
...
def capabilities_endpoint():
    return {
        **engine.capabilities(),
        "location": {"enabled": True, "consent_required": True, "navigation_ready": False},
        "reminders": {"enabled": True, "sound_brand": "PROPHÈTE KESMANER HENRY", "client_delivery_required": True},
    }
